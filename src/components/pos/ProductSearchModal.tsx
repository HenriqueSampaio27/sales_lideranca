  ...
  return (
    ...
    >
      <div
        ...
        className="w-[900px] h-[750px] max-h-[90vh] flex flex-col border p-8 relative animate-in zoom-in-95 duration-200"
      >
        {/* Fechar */}
        <button
          type="button"
        ...
        <div className="mb-6">
          ...
          >
            Lista de <span style={{ color: posColors.primary }}>Produtos</span>
          </h2>
          <p
            style={{ color: posColors.textSecondary }}
